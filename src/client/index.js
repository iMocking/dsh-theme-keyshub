/**
 * dsh-theme-keyshub — browser half (plain JS, no build-time imports).
 *
...
const ROW_CARDS = [
  { id: 'nexus', name: 'NEXUS', preview: '/dsh-theme-keyshub/nexus.jpg', dots: ['#00f0ff', '#ff2d95'] },
  { id: 'comiket', name: 'COMIKET', preview: '/dsh-theme-keyshub/comiket.jpg', dots: ['#ff6b2b', '#3b9eff'] },
  { id: 'ironcore', name: 'IRONCORE', preview: '/dsh-theme-keyshub/ironcore.jpg', dots: ['#f0a030', '#4ecdc4'] },
]

const QUICK_CARDS = [
  { id: 'nexus', name: 'NEXUS 赛博霓虹', swatch: '/dsh-theme-keyshub/nexus.jpg' },
  { id: 'comiket', name: 'COMIKET 温暖纸感', swatch: '/dsh-theme-keyshub/comiket.jpg' },
  { id: 'ironcore', name: 'IRONCORE 机械工业', swatch: '/dsh-theme-keyshub/ironcore.jpg' },
]
...
function apply(ctx) {
  ...
  slots.inject('settings.general.item', () => slots.register(
    { name: 'settings.general.item', id: 'dsh-theme-keyshub-appearance', order: 11, inject: face },
    ThemeRow,
  ))
  slots.inject('sidebar.footer.action', () => slots.register(
    { name: 'sidebar.footer.action', id: 'dsh-theme-keyshub-quick', order: 10, inject: face },
    ThemeFooterAction,
  ))
}
